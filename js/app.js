$(function() {
    ...
    function print_progress(status, total, text) {
        ...
        if(text !== true) {
            if(text.length > 33) text = text.substr(0,30) + "...";
    ...
    function not_found() {
        $(list_section).find("ul").html("<li><p>Nichts gefunden!</p></li>");
    }  
    ...
    function init() {
        ...
        oDictWorker.addListener("printHistory", function (cache) {
